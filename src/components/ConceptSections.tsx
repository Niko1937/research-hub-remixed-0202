    ...
    <section id="concept-section" className="border-b border-border">
      <div className="max-w-6xl mx-auto px-6 py-5">
        <Accordion type="multiple" className="space-y-2">
          {/* 背景と課題 */}
          <AccordionItem value="background" className="border rounded-lg px-4 bg-card/30">
          ...
          {/* 現在の機能 */}
          <AccordionItem value="features" className="border rounded-lg px-4 bg-card/30">
            <AccordionTrigger className="text-base font-semibold text-foreground hover:no-underline">
              今できること（最小構成の7機能）
            </AccordionTrigger>
            <AccordionContent>
          ...
          {/* 本質は拡張性 */}
          <AccordionItem value="extensibility" className="border rounded-lg px-4 bg-card/30">
            <AccordionTrigger className="text-base font-semibold text-foreground hover:no-underline">
          ...
          {/* FAQ */}
          <AccordionItem value="faq" className="border rounded-lg px-4 bg-card/30">
            <AccordionTrigger className="text-base font-semibold text-foreground hover:no-underline">
              よくある質問
            </AccordionTrigger>
            <AccordionContent>
