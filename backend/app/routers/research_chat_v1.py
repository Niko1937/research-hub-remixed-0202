"""
Research Chat Router V1 (Legacy)

/api-v1/research-chat エンドポイント
SSE (Server-Sent Events) ストリーミング対応

Note: This is the legacy v1 implementation preserved for backward compatibility.
The main /api/research-chat endpoint may be updated with new functionality in the future.
"""
